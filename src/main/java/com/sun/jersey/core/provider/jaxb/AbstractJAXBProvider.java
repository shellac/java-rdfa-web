...
public abstract class AbstractJAXBProvider<T> extends AbstractMessageReaderWriterProvider<T> {    
    ...
    protected final Object getUnmarshaller(Class type, MediaType mt)  {
    	return null;
    }
    
    protected final Object getMarshaller(Class type, MediaType mt)  {
    	return null;
	}
    
    protected Object getStoredJAXBContext(Class type)  {
    	return null;
    }
