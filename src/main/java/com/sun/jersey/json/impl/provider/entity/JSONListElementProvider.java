...
public class JSONListElementProvider extends AbstractListElementProvider {
    ...
    @Override
    public final void writeList(Class<?> elementType, Collection<?> t, MediaType mediaType, Charset c, Object m, OutputStream entityStream) {
    	
    }

    @Override
    protected final Object getXMLStreamReader(Class<?> elementType, MediaType mediaType, Object u, InputStream entityStream) {
    	return null;
    }
}
